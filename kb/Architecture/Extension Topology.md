...
| `crucible-models/` | `crucible` | Training pipelines, trained-artifact packs, and classifier suggestors. |
...
| `prism-analytics/` | `prism` | Closed-form analytics, feature extraction, inference, fuzzy logic, and analytic packs. |
