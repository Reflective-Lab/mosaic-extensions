...
| `crucible-models/` | `crates/crucible` | Training pipelines, trained-artifact packs, and classifier suggestors | Extracted model/training repo. |
...
| `prism-analytics/` | `crates/prism` | Closed-form analytics, fuzzy inference, and feature/inference suggestors | Extracted from `converge/crates/analytics`; branch `main`; local git repo. |
...
Product and showcase repositories live outside this extension container.
